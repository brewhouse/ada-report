...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .cover .logo-text { font-size: 13px; font-weight: 600; letter-spacing: 2px; text-transform: uppercase; color: #6366f1; margin-bottom: 20px; }
    .cover h1 { font-size: 32px; margin-bottom: 8px; }
    .cover .site-url { font-size: 18px; color: #6366f1; margin-bottom: 6px; }
    ...
    .print-btn { position: fixed; top: 20px; right: 20px; background: #6366f1; color: white; border: none; padding: 10px 20px; border-radius: 6px; cursor: pointer; font-size: 14px; font-weight: 600; box-shadow: 0 2px 8px rgba(0,0,0,0.2); z-index: 1000; }
...
<body>
  ...
  <div class="page">
    ...
    <!-- Cover -->
    <div class="cover">
      <div class="logo-text">ADA Accessibility Auditor</div>
    ...
    <div class="footer">
      Generated by ADA Accessibility Auditor &bull; Powered by Google Lighthouse<br>
